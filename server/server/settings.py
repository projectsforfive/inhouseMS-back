...
SECRET_KEY = 'django-insecure-^4#6$8a*o_k)rmhe&43wzkl3qx7gq0%^ij+&zd_^f1+#o_%@wb'
...
CORS_ALLOW_HEADERS = [
    ...
    "x-csrftoken",
    "x-requested-with",
    # Add any other custom headers you want to allow
]
...
GOOGLE_CREDENTIALS = {
    ...
    "private_key": config('PRIVATE_KEY').replace('\\n', '\n'),  # Make sure to format the key correctly
